...
# Percorso di Java 1.8 (modificato per il Dockerfile specificato)
java1_8_path="/usr/local/openjdk-8/bin/java"

# Percorso di javac (modificato per il Dockerfile specificato)
javac="/usr/local/openjdk-8/bin/javac"
